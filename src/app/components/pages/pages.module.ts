...
import { VerPostulacionEmpleadorComponent } from './postulaciones/ver-postulacion-empleador/ver-postulacion-empleador.component';
import { FechaNacimientoPipe } from '../../pipes/fecha-nacimiento.pipe';
import { CargandoComponent } from './cargando/cargando.component';
import { VerPostulacionSolicitanteComponent } from './postulaciones/ver-postulacion-solicitante/ver-postulacion-solicitante.component';
@NgModule({
  declarations: [
    GeneroPipe,
    FechaNacimientoPipe,
    ...
    VerPostulacionEmpleadorComponent,
    CargandoComponent,
    VerPostulacionSolicitanteComponent,
    ],
  exports: [
    DashboardComponent,
    PagesComponent,

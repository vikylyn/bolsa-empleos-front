...
export class ListaNotificacionesSolicitanteComponent implements OnInit, OnDestroy {
  myModal = false;
  ...
  ngOnInit(): void {
    this.notificacionesSubscription =  this.notificacionService.recibirNotificacionesNuevas().subscribe(( () => {
      this.cargarNotificaciones();
    }));
  }
  cargarNotificaciones(): void {
    this.cargando = true;
    this.notificacionService.listarConPaginacion(this.loginService.solicitante.id,
        this.loginService.solicitante.credenciales.rol.id, this.desde)
